...
public class FileUtils {
    ...
    public static String getExtension(String description) {
     ...
     */
    public static File getSaveFileName(JFrame parent, String[] extensions) {
        ...
        if (fileChooser.showSaveDialog(parent) == JFileChooser.APPROVE_OPTION) {
            ...
            String extension = getExtension(fileChooser.getFileFilter().getDescription());
     ...
     */
    public static File getOpenFileName(JFrame parent, String[] extensions) {
        JFileChooser fileChooser = new JFileChooser();
        for (String extension : extensions) {
            FileFilter filter = new ExtensionFileFilter(extension);
            fileChooser.addChoosableFileFilter(filter);
